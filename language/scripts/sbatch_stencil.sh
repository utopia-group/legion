...
for i in 0 1 2 3; do
    ...
    for r in 0 1 2 3 4; do
	    ...
	    srun -n $n -N $n --ntasks-per-node 1 --cpu_bind none /lib64/ld-linux-x86-64.so.2 "$root_dir/stencil.spmd10" -nx 40000 -ny 40000 -ntx $(( nx * 2 )) -nty $(( ny * 5 )) -tsteps 100 -tprune 5 -hl:sched -1 -ll:cpu 10 -ll:io 1 -ll:util 1 -ll:dma 2 -ll:csize 30000 -ll:rsize 512 -ll:gsize 0 -hl:prof 4 -level legion_prof=2 -logfile prof_"$n"x10_r"$r"_%.log | tee out_"$n"x10_r"$r".log
        fi
    done
done
